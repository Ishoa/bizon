...
namespace XNAWalkyrie
{
    public static class MathExtensions
    {
        ...
        public static Vector2 Linear(Vector2 pos1, Vector2 pos2, float t) // retuns a position on a linear bezier curve
        {
            return pos1 = pos1 + (pos2 - pos1) * t;
        }


        public static Vector2 Quad(Vector2 pos1, Vector2 pos2, Vector2 pos3, float t) //returns the position on a quadratic bezier curve
        {

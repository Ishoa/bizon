...
namespace XNAWalkyrie
{
    ...
    {
        static private Device joystickDevice;
        static private JoystickState state;
        ...
        static private string[] systemJoysticks;
        ...
        public Joystick()
        {
            hWnd = Utility.Game.Window.Handle;
            axisA = -1;
            axisB = -1;
            axisC = -1;
            axisD = -1;
        ...
        static public string[] FindJoysticks()
        {

...
namespace XNAWalkyrie
{
    public static class Intersection
    {
        ...
        public static bool PointInsidePoly(
            ref Vector3 vA, ref Vector3 vB, ref Vector3 vC, ref Vector3 p)
        {
            int pos = 0;
            int neg = 0;
        ...
        public static void ClosestPointOnSegment(Vector3 c, Vector3 a, Vector3 b,
        ...
        public static void ClosestPtPointSegment2D(
            Vector2 c, Vector2 a, Vector2 b, ref float t, ref Vector2 d)
        {
            Vector2 ab = b - a;
        ...
        public static bool IntersectSegmentTriangle(
            Vector3 p, Vector3 q, Vector3 a, Vector3 b, Vector3 c,

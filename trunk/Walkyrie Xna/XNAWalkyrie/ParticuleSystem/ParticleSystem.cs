...
namespace XNAWalkyrie
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public int NbActiveParticules()
        {
            int res = 0;

            if (firstActiveParticle <= firstFreeParticle)
                res = firstFreeParticle - firstActiveParticle;
            else
                res = settings.MaxParticles - firstActiveParticle + firstFreeParticle;
        ...
        void LoadParticleEffect()
        {
            ...
            if (particleEffect == null)
                throw new ContentLoadException("Failed to load ParticleEffect.fx");
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (firstActiveParticle != firstFreeParticle)
            {
                ...
                effectViewParameter.SetValue(Utility.Camera.ViewMatrix);
                effectProjectionParameter.SetValue(Utility.Camera.ProjectionMatrix);

...
namespace XNAWalkyrie
{
    ...
    public class ParticleEmitter
    {
        ...
        ParticuleManager.ListParticuleSystem particleSystem;
        ...
        /// </summary>
        public ParticleEmitter(ParticuleManager.ListParticuleSystem particleSystem,
        ...
        public void Update(GameTime gameTime, Vector3 newPosition)
        {
            ...
            if (elapsedTime > 0)
            {
                ...
                while (timeToSpend > timeBetweenParticles)
                {
                    ...
                    // Create the particle.
                    Utility.ParticuleManager.AddParticule(particleSystem, position, velocity);
                }

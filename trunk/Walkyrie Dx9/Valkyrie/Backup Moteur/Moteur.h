...
public:
	...
	CScene*		m_pScene;					// Pointeur sur la Scène à afficher
	...
	bool	 CreationSceneMoteur(CScene * pScene, int Largeur = 640, int Hauteur = 480, bool PleinEcran = false);

	bool     Creation(HINSTANCE hInstance);
	void	 Destruction();

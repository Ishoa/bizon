...
technique RenderSceneWithTexture4Light
{
    pass P0
    {          
        VertexShader = compile vs_2_0 RenderSceneVS( 4, true, false );
        PixelShader  = compile ps_2_0 RenderScenePS( true ); // trivial pixel shader (could use FF instead if desired)
    }
}

technique RenderSceneNoTexture1Light
{
    pass P0
    {          
...
technique RenderSceneNoTexture2Light
{
    pass P0
    {          
        VertexShader = compile vs_2_0 RenderSceneVS( 2, false, false );
        PixelShader  = compile ps_2_0 RenderScenePS( false ); // trivial pixel shader (could use FF instead if desired)
    }
}

technique RenderSceneNoTexture3Light
{
    pass P0
    {          
        VertexShader = compile vs_2_0 RenderSceneVS( 3, false, false );
        PixelShader  = compile ps_2_0 RenderScenePS( false ); // trivial pixel shader (could use FF instead if desired)
    }
}

technique RenderSceneNoTexture4Light
{
    pass P0
    {          
        VertexShader = compile vs_2_0 RenderSceneVS( 4, false, false );
        PixelShader  = compile ps_2_0 RenderScenePS( false ); // trivial pixel shader (could use FF instead if desired)
    }
}

technique RenderSceneNoTextureNoLight
{
    pass P0
    {          
        VertexShader = compile vs_2_0 RenderSceneVS( 0, false, false );
        PixelShader  = compile ps_2_0 RenderScenePS( false ); // trivial pixel shader (could use FF instead if desired)
    }
}
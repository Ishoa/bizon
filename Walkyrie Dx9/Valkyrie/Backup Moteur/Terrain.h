...
public:
	...
	LPDIRECT3DTEXTURE9 m_pTxHerbe;			// pointeur sur la texture d'herbe
	LPDIRECT3DTEXTURE9 m_pTxTerre;			// pointeur sur la texture de terre
	LPDIRECT3DTEXTURE9 m_pTxDensiteTerre;	// pointeur sur la texture de densité de terre
	LPDIRECT3DTEXTURE9 m_pTxEau;			// pointeur sur la texture d'eau
	LPDIRECT3DTEXTURE9 m_pTxDensiteEau;		// pointeur sur la texture de densité d'eau
	...
	bool CreationTerrain(char* FichierMapTerrain);
	...
	bool ChargerMapHauteur(char* FichierMapTerrain);

...
public:
	...
	DIJOYSTATE2* m_pEtatJoystick;				//pointeur sur l'état du Joystick
	...
	DIJOYSTATE2* GetEtatJoystick(){return m_pEtatJoystick;}
	...
	virtual void Aquisition(BYTE EtatClavier[], DIMOUSESTATE* pEtatSouris,DIJOYSTATE2* pEtatJoystick){}
	virtual void Animation(double TempsEcouler, double DeltaTemps){}
	virtual void Rendu();
	virtual void RenduInterface(){}

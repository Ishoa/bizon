...
bool CInterface::Creation()
{
	...
	D3DXCreateFontA(m_pD3DDevice, 20, 0, FW_BOLD, 1, false, DEFAULT_CHARSET,
...
void CInterface::DrawTextureSprites(CLPTexture texture, RECT texcoords, float x, float y, int a)
{
	...
	m_pD3DSpt->Draw(texture.getDXTexture(), &texcoords, &center, &position, D3DCOLOR_ARGB(a,255, 255, 255));
